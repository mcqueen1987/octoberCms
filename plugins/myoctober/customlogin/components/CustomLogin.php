<?php namespace MyOctober\CustomLogin\Components;
...
class CustomLogin extends ComponentBase
{
    ...
    protected function sendActivationEmail($user)
    {
        ...
        Mail::send('php.user::mail.activate', $data, function ($m) use ($user) {
            $m->from('xdb1987@gmail.com', 'XX App');
            $m->to($user->email, $user->name)->subject('Active your email!');
        });
    }
